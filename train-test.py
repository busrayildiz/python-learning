...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  1 18:54:47 2021
...
dataset = np.loadtxt('/Users/busrayildiz/Desktop/diabetes.csv', delimiter=',',skiprows=1)
...
model.fit(training_dataset_x, training_dataset_y,batch_size=32,epochs=90,validation_split=0.2)
"""

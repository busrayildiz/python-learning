...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 25 18:24:37 2021
...
class WordConverter:
    ...
    def get_word_dict(self):
        return {word: index for index, word in enumerate(self.word_set)}  #dictionary_comprehension
...
def vectorize(iterable,colsize):
    result = np.zeros((len(iterable), colsize))
